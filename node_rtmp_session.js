...
class NodeRtmpSession {
  ...
  rtmpInvokeHandler() {
    ...
    switch (invokeMessage.cmd) {
      ...
      case 'deleteStream':
        ...
        break;
      case 'closeStream':
        this.onCloseStream(invokeMessage);
  ...
  onConnect(invokeMessage) {
    invokeMessage.cmdObj.app = invokeMessage.cmdObj.app.replace('/', ''); 
    if (!this.isIPC) {
    ...
    //// De set sau chuyen nhieu bandwidth
    ///////////////////////////////////////
    ///////////////////////////////////////
    ///////////////////////////////////////
    ///////////////////////////////////////////
  ...
  onPublish(invokeMessage) {
    ...
    context.nodeEvent.emit("Streamer_online",invokeMessage.streamName);
  ...
  onDeleteStream(invokeMessage) {
    ...
    if (invokeMessage.streamId == this.publishStreamId) {
      if (this.isPublishing) {
        if (!this.isIPC) {
          let name = this.publishStreamPath.replace('/live/','');
          context.nodeEvent.emit("Streamer_offline",name);
